    ...
    div(class = "app-header",
        ...
        fluidRow(column(width = 2,
                 ...
                 column(width = 8,
                        align = "center",
                        h2(class = "app-title",
                           "Holistic Decision Analysis for an Agrosilvopastoral System")),
                 column(width = 2,
                        align = "left",
    ...
    sidebarPanel(width = 4,
                 ...
                 accordion(
                   ...
                   accordion_panel(
                     ...
                     sliderInput("num_simulations_c", "Number of Simulations",
                                  min = 10, max = 10000, value = c(100), step = 10),
                     numericInput("n_years_c", "Simulation period in years",
                                  min = 1, max = 100, value = 40),
                     sliderInput("discount_rate_p", "Discount rate (%)",
                                 min = 1, max = 50, value = c(1.8,5), step = 0.1),
                   ...
                   accordion_panel(
                     ...
                     sliderInput("tree_planting_p", "Cost of digging tree well & planting tree shrub [h/tree]",
                                 min = 0.1, max = 10, value = c(0.1,0.5), step = 0.1),
                     sliderInput("farmer_planning_time_p", "Time spent planning by farmer [h]",
                                 min = 1, max = 500, value = c(10,40), step = 1),
                     sliderInput("planning_consulting_p", "Consultant fees [GBP]",
                                 min = 0, max = 10000, value = c(500,1000)),
                     sliderInput("weed_protection_p", "Cost of controlling weeds during establishment [h]",
                                 min = 0, max = 5000, value = c(15,25), step = 1),
                     br(),
                     h4("Design 1"),
                     numericInput("AF1_tree_row_area_c", "Total area of tree rows [ha]",
                                  min = 0.01, max = 100, value = 0.8),
                     numericInput("AF1_num_trees_c", "Number of trees",
                                  min = 0, max = 100000, value = 5926, step = 1),
                     sliderInput("AF1_plant_protection_p", "Cost of fencing [GBP/tree]",
                                 min = 0, max = 10, value = c(0.843,1.022), step = 0.1),
                     sliderInput("SRC_cutting_price_p", "Price of willow cuttings [GBP]",
                                 min = 0, max = 5, value = c(0.1,0.6), step = 0.1),
                     sliderInput("SRC_field_prep_p", "Subsoiling and harrowing time [h/ha]",
                                 min = 1, max = 10, value = c(2.6,3.8)),
                     sliderInput("SRC_planting_p", "Time spent planting cuttings mechanically [h/ha]",
                                 min = 1, max = 100, value = c(10,50),
                     sliderInput("SRC_machine_rent_p", "Rent of planting machine [GBP/h]",
                                 min = 1, max = 500, value = c(150,300)),
                     sliderInput("harvest_interval_SRC_p", "Number of years between SRC harvest [ha]",
                                 min = 1, max = 7, value = c(3,4)),
                     sliderInput("af1_added_management_time_factor_p", "Extra time for managing AF vs. Baseline [% of Baseline]",
                                 min = 1.00, max = 2.0, value = c(1.05,1.2), step = 0.01),
                     sliderInput("AF1_soil_loss_water_p", "Soil loss due to water [tons/ha*year]",
                                 min = 1, max = 10, value = c(1.7,3.2), step = 0.1),
                     sliderInput("AF1_soil_loss_wind_p", "Soil loss due to wind [tons/ha*year]",
                                 min = 1, max = 10, value = c(2,4), step = 0.1),
                     sliderInput("af1_less_grazing_management_time_factor_p", "Reduced livestock mgmt time due to AF [% of Baseline]",
                                 min = 0.5, max = 1.0, value = c(0.8,0.9), step = 0.01),
                     sliderInput("AF1_woody_benefit_windreduc_p", "Livestock Performance Enhancement due to Wind Shelter [%]",
                                 min = 0, max = 0.5, value = c(0.01,0.02), step = 0.01),
                     selectInput(
                     ...
                     sliderInput("bcherry_tree_cost_p", "Price of a bird cherry sapling [GBP]",
                                 min = 1, max = 50, value = c(1.77,1.99), step = 0.1),
                     numericInput("AF2_num_shrubs_c", "Number of Shrubs",
                                  min = 0, max = 20000, value = 900),
                     sliderInput("shrub_price_p", "Price per shrub [GBP/shrub]",
                                 min = 0.1, max = 10, value = c(0.2,0.3), step = 0.1),
                     sliderInput("AF2_plant_protection_p", "Cost of fencing [GBP/tree]",
                                 min = 1, max = 50, value = c(11.39,14.81), step = 0.1),
                     sliderInput("af2_added_management_time_factor_p", "Extra time for managing AF vs. Baseline [% of Baseline]",
                                 min = 1.0, max = 2.0, value = c(1.05,1.2), step = 0.01),
                     ...
                     sliderInput("AF2_soil_loss_wind_p", "soil loss due to wind [tons/ha*year]",
                                 min = 1, max = 50, value = c(1.3,3.6)),
                     sliderInput("af2_less_grazing_management_time_factor_p", "Reduced livestock mgmt due to AF [% of Baseline]",
                                 min = 0.5, max = 1, value = c(0.8,0.9), step = 0.01),
                     sliderInput("AF2_woody_benefit_windreduc_p", "Livestock Performance Enhancement due to Wind Shelter [%]",
                                 min = 0.01, max = 0.5, value = c(0.03,0.06), step = 0.01),
                   ...
                   accordion_panel(
                     ...
                     sliderInput("summer_beans_yield_p", "Yield [t/ha]",
                                 min = 1, max = 30, value = c(1.5,4.5), step = 0.1),
                     sliderInput("summer_beans_value_p", "Sale price [GBP/t]",
                                 min = 1, max = 1500, value = c(500,600)),
                     h5 ("Winter Oats"),
                     sliderInput("winter_oats_yield_p", "Yield [t/ha]",
                                 min = 1, max = 30, value = c(1.5,6), step = 0.1),
                     sliderInput("winter_oats_value_p", "Sale price [GBP/t]",
                                 min = 1, max = 1500, value = c(5,10)),
                     h5 ("Winter Cover Crops"),
                     sliderInput("winter_cover_crop_yield_p", "Yield [t/ha]",
                                 min = 1, max = 50, value = c(3,6), step = 0.1),
                   ),
                   accordion_panel(
                     title = "Animals",
                     icon = icon("cow"), 
                     #h4("Animals"),
                     sliderInput("grazing_efficiency_p", "Percentage of pasture effectively grazed [%]",
                                 min = 0.01, max = 1, value = c(0.65,0.8), step = 0.01),
                     sliderInput("herbal_grazing_labour_p", "Labour for livestock management in paddock [h/ha*year]",
                                 min = 1, max = 100, value = c(2,9)),
                     sliderInput("beef_value_p", "Price of selling live cows [GBP/Kg]",
                                 min = 1, max = 50, value = c(4.2,5.8), step = 0.1),
                   ...
                   accordion_panel(
                     ...
                     sliderInput("winter_grazing_effect_p", "Positive effect from winter grazing [% of Baseline]",
                                 min = 1, max = 2, value = c(1.05,1.15), step = 0.01),
                     # sliderInput("per_market_price_p", "% fluctuation in market price of all products [%]",
                     #             min = 0.01, max = 1, value = c(1,5)),
                   ),
                   accordion_panel(
